# Decoding OM3
An open source project to fearlessly peer inside OM3! Contributions _extremely_ welcome! See rendered pages at [https://decoding-access-om3.readthedocs.io/](https://decoding-access-om3.readthedocs.io/season1/).
