...
# Get started...
All community members are welcome to contribute or correct errors/typos. To get write access, [create an issue and request access](https://github.com/ACCESS-Community-Hub/decoding-om3/issues/new). You're also welcome to make a fork and put in a pull request. 
